...
------------------------------------------------------------
entity tb_driver_7seg_8characters is
    -- Entity of testbench is always empty
end entity tb_driver_7seg_8characters;

------------------------------------------------------------
-- Architecture body for testbench
------------------------------------------------------------
architecture testbench of tb_driver_7seg_8characters is
...
begin
    ...
    uut_driver_7seg_8characters : entity work.driver_7seg_8characters
        port map(
            clk     => s_clk_100MHz,
            reset   => s_reset,
            data0_i => s_data0,
